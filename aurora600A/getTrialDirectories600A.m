function [codeDir, codeProtocolDir,codeWaveDir,codeLabelDir,dateId] = ...
    getTrialDirectories600A(projectFolders, appendIdName, ...
    settingsExperiment)
...
if(codeDirExists==1 && forceClean == 0)
    ...
    for i=1:1:length(fileFolderList)
        ...
        if(fileFolderList(i).isdir && strcmp(fileFolderList(i).name,'wave'))
            waveDirExists=1;
        end
    end
