...
switch perturbationSettings.waveType
    ...
    case 'larb'
        ...
        for i=1:1:nWaves
            ...
            stochasticWaves(i).metadata.(auroraConfig.labels.bandwidth) = ...
                larbStochasticWaveSet(i).wave.config.arbitraryWaveform.bandwidth;
            stochasticWaves(i).metadata.(auroraConfig.labels.amplitude) = ...
                max(larbStochasticWaveSet(i).wave.config.magnitude);
            stochasticWaves(i).metadata.(auroraConfig.labels.pointCount) = ...
                max(larbStochasticWaveSet(i).wave.config.points);
            stochasticWaves(i).metadata.(auroraConfig.labels.frequency) = ...
