...
auroraConfig.maximumSpeedInLPS = ...
    auroraConfig.maximumSpeedInMPS/(approximateSampleLengthInMM/1000);
...
auroraConfig.maximumSpeedInDefaultUnits = ...
    auroraConfig.maximumSpeedInLPS/1000; %lengths per millisecond
