function indexEnd = ...
  createImpedanceForceLengthExperiments600A_LarbSine(...
                      indexStart,...
                      seriesName,...
                      settingsImpedance,...
                      stochasticWaveSet,...
...
for idxZ = 1:1:length(settingsImpedance.isometricNormLengths)
  ...
  for idxT=1:1:2
    ...
    switch idxT
      case 1
        ...
        zTrialSettings.target.length= settingsImpedance.isometricNormLengths(idxZ);
        zTrialSettings.activationScaling = ...
          settingsImpedance.isometricActivationDurationMultiple(idxZ);
    ...
    if(strcmp(blockName,'zActive')==1 && idxT==2)
      blockName = 'isometricProbe';
      startingLength = 1.0;
      startingBathId = auroraConfigWaveSet.bath.passive;
      trialKeywords = {'Impedance-Isometric-Probe-Trial'};
      jsonFileNameArray = createImpedanceProbeTrial600A(...    
                          fileCount,...                    
                          seriesName,...
                          blockName,...
                          startingLength,...
                          startingBathId,...
                          zTrialSettingsDefault.sineSeries.amplitude,...
                          sinProbeSeries,...                        
                          fidProtocol,...
                          auroraConfigLowRes,...
                          trialFileFolderSettings,...
...
for idxC = 1:1:2
  ...
  switch idxC
    case 1
      ...
      zTrialSettings.activationScaling =1;     
