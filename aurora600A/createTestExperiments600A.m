...
% Characterization
%%
[codeDir, codeLabelDir,dateId] = getTrialDirectories(projectFolders,'_test');
...
for idxField = 1:1:numberOfFvTrials
    ...
    fname       = getTrialName('',idx,trialType,startLength,dateId,'.pro');
    fnameLabels = getTrialName('',idx,trialType,startLength,[dateId,'_labels'],'.csv');
        ...
        switch i 
            ...
            case 2
                ...
                for j=1:1:length(settingsForceLengthImpedanceDynamic.normLengths(indexSeries,:))
                    ...
                    startTime       = interp1(lengthVectorTotal,timeVectorTotal,lj);
                    startTimeInS    = startTime*(1/scaleTime);
                    ...
                    if(flag_emptyVectors==1)
                        ...
                        durationVector = [durationVector;(startTime-signalVec.time(end))];                    
                    end
                ...
                lengthVector    = [lengthVector;(lj-li)];
                waitTimeVector  = [waitTimeVector;auroraConfig.minimumWaitTime];
                durationVector  = [durationVector;(startTime-waitTimeVector)];                    
