function [options,isValid,msg]= ...
            getCommandFunctionOptions600AUpd(controlFunctionName,...
                                             auroraConfig,...
                                             isRelativeOverride)
...
switch controlFunctionName
    case 'Length-Step'
        ...
        isRelative = auroraConfig.useRelativeUnits;
        if(~isempty(isRelativeOverride))
          isRelative = isRelativeOverride;
        end

        i=1;
        options(i).unit = auroraConfig.defaultLengthUnit;
        options(i).printUnit = 1;
        options(i).isRelative = isRelative;
