...
auroraConfig.postMovementPauseTimeInSeconds = 0.0002; 
...
configExperiment.injury.lengths     = [0,0.4,0;...
                                       0,0,0;...
                                       0,0.5,0;...
                                       0,0,0;...
                                       0,0.6,0;...
...
configExperiment.injury.comments = ...
    {'Injury','If Fmax is 20% lower goto trial 18 passive',...
     'Injury','If Fmax is 20% lower goto trial 18 passive',...
     'Injury','If Fmax is 20% lower goto trial 18 passive'};
...
for i=1:1:length(trials)
    ...
    if(isempty(auroraCommands.time)==0)
        ...
        timeUnique = unique(auroraCommands.time);
        if(length(timeUnique)<length(auroraCommands.time))
            here=1;
        end
