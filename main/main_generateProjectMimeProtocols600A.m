...
if(flag_generateExponentiallySpacedSinusoids==1)
  ...
  %sineProbeSettings.maxSinusoidDurationS              = (1/sineProbeSettings.minFrequencyHz)+sqrt(eps);
  sineProbeSettings.preferredSinusoidDurationS        = 0.1;
  sineProbeSettings.minCycleCount                     = 3;
  sineProbeSettings.maxCycleCount                     = 10;
  sineProbeSettings.maxAngularErrorDegrees            = 0.1;
  sineProbeSettings.frequencyHzTolerancePercentage    = 0.075;
  sineProbeSettings.flag_correctFrequencyToSampleRate =1;
