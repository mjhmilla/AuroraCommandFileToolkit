...
auroraConfig.numberOfEmptyCommandsPrepended = 30;
...
maximumCommands    = (auroraConfig.maximumNumberOfCommands ...
                      -auroraConfig.numberOfEmptyCommandsPrepended ...
                      - paddingPointsToAppend);

commandTimeVector  = [1:1:auroraConfig.maximumNumberOfCommands]'...
                        .*(1/commandRateHz);
...
switch signalType
    case 0
        ...
        idx1        = auroraConfig.numberOfEmptyCommandsPrepended;
    ...
    case 2
        ...
        commandSignal = [zeros(auroraConfig.numberOfEmptyCommandsPrepended,1);...
...
fileName = sprintf('%s__%s_Lo__%i_osc__%i_HzAD__%i_pre.pro',...
            signalName, ...
            magnitudeStr,...
            signalOscillations,...
            round(auroraConfig.analogToDigitalSampleRateHz),...
            auroraConfig.numberOfEmptyCommandsPrepended);
...
auroraCommandFile = readAuroraCommandFile(filePath);
...
figSignal = figure;
    subplot('Position',reshape(subplotPanel(1,1,:),1,4));
        ...
        ignoreBoxTime = ...
            [commandTimeVector(1:1:auroraConfig.numberOfEmptyCommandsPrepended);...
            fliplr(commandTimeVector(1:1:auroraConfig.numberOfEmptyCommandsPrepended)')';...
            commandTimeVector(1,1)];
        ignoreBoxValue = ...
            [ones(auroraConfig.numberOfEmptyCommandsPrepended,1).*minVal;...
             ones(auroraConfig.numberOfEmptyCommandsPrepended,1).*maxVal;...
             minVal];
...
figSignal = configPlotExporter(figSignal,plotConfigUpd);        

saveas(figSignal,fullfile(projectFolders.output_plots,...
                            'fig00_generateAuroraFile'),'fig');
saveas(figSignal,fullfile(projectFolders.output_plots,...
                            'fig00_generateAuroraFile'),'pdf');