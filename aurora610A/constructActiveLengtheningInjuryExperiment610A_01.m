...
prePostTimeSeriesDataDir= fullfile(expFoldersUpd.timeSeriesDataFolderName,rampFolderName);
prePostTimeSeriesImagesDir= fullfile(expFoldersUpd.timeSeriesImagesFolderName,rampFolderName);
  ...
  for idxTrialType=1:1:4
    ...
    switch idxTrialType
      case 1
        ...
        % Probe trial
        %
        success = createActivePassiveProbeTrial610A_01(...
                                  startEndLength,...
                                  trialFileNameNoExt,...                                     
                                  auroraConfig,...
                                  expConfig,...
