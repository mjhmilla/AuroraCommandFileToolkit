...
for idxTrialType = 1:1:length(degradationConfig.exp.numberOfTrials)
  ...
  for idxTrial = 1:1:degradationConfig.exp.numberOfTrials(idxTrialType)
    ...
    for idxFile=1:1:2
      ...
      switch idxFile
        case 1
          sampleFrequency = auroraConfigDefault.analogToDigitalSampleRateHz;
    
          auroraConfig = getDefaultAuroraConfiguration610A(...
                              degradationConfig.muscle.name,...
                              sampleFrequency,...    
                              degradationConfig.muscle.lceOptMM,...
                              degradationConfig.muscle.vceMaxLPS);
        ...
        case 2
          ...
          sampleFrequency = degradationConfig.recovery.sampleFrequency;
      ...
      switch idxFile
        ...
        case 2
          ...
          programMetaData = ...
              writeClosingBlock610A(...
                  fid,...
                  degradationConfig.timing.stopWaitTime,...
                  auroraConfig,...
                  programMetaData,...
                  flag_printMetaDataToFile);
...
jsonSequenceMetaData.experiment.manually_measured_temperature_C ...
  = degradationConfig.muscle.temperature;
