...
switch controlFunctionName
    ...
    case 'Sine Wave'
      ...
      if(configVibration.fitPerturbationPowerSpectrum==1)
         ...
         argScale = 1/configVibration.frequencyRange(1,1);
    
         x0       = [randomSignals.frequency(indexArg,1).*argScale];
         ...
         lb = [ones(size(indexArg)).*(argScale(1,1)*configVibration.frequencyRange(1,1))];
    
         ub = [ones(size(indexArg)).*(argScale(1,1)*configVibration.frequencyRange(1,2))];
         ...
         [x1,resnorm,residual,exitflag] = ...
          ...
          randomSignals.frequency= x1(i0:i1,1)./argScale(1,1);
