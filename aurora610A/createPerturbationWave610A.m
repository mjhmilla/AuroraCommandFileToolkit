...
flag_optimizeAmplitude=1;
flag_optimizeFrequencyDistribution=0;
...
switch controlFunctionName
    ...
    case 'Ramp'    
      ...
      [timeVec,...
       ...
       if(configVibration.fitPerturbationPowerSpectrum==1 ...
         ...
         fcnWave = @(arg)createRampWavePattern610A_FcnWrapper(...
                            arg,...
                            indexArg,...
                            fcnMeanLength,...
                            configVibration,...
    ...
    case 'Sine Wave'
      ...
      if(configVibration.fitPerturbationPowerSpectrum==1 ...
                && flag_enableFitting == 1 ...
                && flag_optimizeFrequencyDistribution)

       n = 10;
       frequencyGrid = ([0:1:n]' ./ n).^0.5;

       frequencyMapDefault = diff(frequencyGrid);
       
       indexArg = [1:1:n]';
  
       argScale = 1;
  
       magnitudeDefault = configVibration.magnitudeRange(1,2);

       x0       = frequencyMapDefault.*argScale;
  
       fcnWave = @(arg)createSineWavePattern610A_V2_FcnWrapper(...
                          arg,...
                          indexArg,...
                          configVibration,...
                          configVibration.frequencyRange,...
         ...
         lb = ones(size(indexArg)).*(min(frequencyMapDefault).*0.25);    
         ub = ones(size(indexArg)).*(max(frequencyMapDefault).*2);
         ...
         [x1,resnorm,residual,exitflag] = ...
          ...
          frequencyMap= x1(i0:i1,1)./argScale(1,1);
...
evenFrequencyDistribution=ones(20,1).*(1/20);
