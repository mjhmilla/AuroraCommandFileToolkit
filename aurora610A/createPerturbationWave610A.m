...
if(length(configVibration.frequencyRange) == 2 ...
    ...
    randomSignals.frequency = ...
        (1-randomVecC).*(configVibration.frequencyRange(1,1)) ...
           +randomVecC.*(2*configVibration.frequencyRange(1,2)...
...
%         end
    ...
    case 'Sine Wave'
      ...
      if(configVibration.fitPerturbationPowerSpectrum==1 || flag_testing == 1)
         ...
         argScale = 1./configVibration.magnitudeRange(1,1);
    
         x0       = [randomSignals.magnitude(indexArg)].*argScale;
    
         fcnWave = @(arg)createSineWavePattern610A_FcnWrapper(...
                            arg,...
                            indexArg,...
                            configVibration,...
                            randomSignals.frequency,...
