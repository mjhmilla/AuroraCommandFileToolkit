...
lengthSineOptions(1).value = expConfig.sineWaveEqualization.frequency;
lengthSineOptions(2).value = expConfig.sineWaveEqualization.amplitude;
lengthSineOptions(3).value = expConfig.sineWaveEqualization.cycles;

sineCycles = expConfig.sineWaveEqualization.cycles;
...
startTime = programMetaData.controlFunction.endTime ...
            + expConfig.sineWaveEqualization.waitTime;
