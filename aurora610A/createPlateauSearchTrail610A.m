...
mdFieldNames = getMetaDataFieldNames610A(auroraConfig.twitch);
...
for idxL = 1:1:length(expConfig.ramp.lengths)
  ...
  %Record the meta data
  sineTime = (expConfig.relax.cycles ...
             /expConfig.relax.frequency);
  ...
  startTime = programMetaData.nextStartTime ...
          ...
          +expConfig.twitch.initialDelay;
  endTime = startTime + expConfig.twitch.pulseWidth*s2ms;
