...
codeDir         = fullfile(projectFolders.output_code,[dateId,'_610A'],'injury');
codeLabelDir    = fullfile(projectFolders.output_code,[dateId,'_610A'],'injury','segmentLabels');
...
for i=1:1:length(fileFolderList)
    if(fileFolderList(i).isdir ...
        && strcmp(fileFolderList(i).name,'injury'))
        codeDirExists=1;
    end
end
