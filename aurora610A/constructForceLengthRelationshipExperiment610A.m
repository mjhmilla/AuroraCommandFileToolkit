function [trialId, expFoldersUpd] = ...
  constructForceLengthRelationshipExperiment610A(...
                                        dateId,...
                                        trialId,...
                                        sequenceId,...
                                        auroraConfig,...
...
fprintf('\nconstructForceLengthRelationshipExperiment610A');
fprintf('  Note: needs to be updated so that all tries start at 0');
...
for idxTrial = 1:1:length(expConfig.ramp.length)
  ...
  for idxFile=1:1:2
    ...
    mdfn = getMetaDataFieldNames610A(auroraConfig.default);
    ...
    switch idxFile
      ...
      case 2
        ...
        trialBlockLabelFilePath = ...
          fullfile( expFoldersUpd.rootFolderPath,...
                    expFoldersUpd.blockLabelsFolderName,...
                    [trialFileNameNoExt,'.csv']);
        
        programMetaData = getEmptyProgramMetaDataStruct610A(...
                            trialBlockLabelFilePath);
        programMetaData = writePreamble610A(...
                            fid,auroraConfig.default,programMetaData);
        ...
        stimulusTetanusOptions = ...
          getCommandFunctionOptions610A(...
             'Stimulus-Tetanus','Stimulator',auroraConfig.default);
        ...
        startTime = expConfig.timing.waitTime;
        endTime   = startTime ...
